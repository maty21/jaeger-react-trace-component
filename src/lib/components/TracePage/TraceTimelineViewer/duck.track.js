...
const logs = (isOpen         ) => trackEvent(CATEGORY_LOGS, getToggleValue(isOpen));
const logsItem = (isOpen         ) => trackEvent(CATEGORY_LOGS_ITEM, getToggleValue(isOpen));
const process = (isOpen         ) => trackEvent(CATEGORY_PROCESS, getToggleValue(isOpen));
const tags = (isOpen         ) => trackEvent(CATEGORY_TAGS, getToggleValue(isOpen));
const detailRow = (isOpen         ) => trackEvent(CATEGORY_ROW, getToggleValue(isOpen));
