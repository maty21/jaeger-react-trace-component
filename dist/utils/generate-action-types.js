...
exports.default = generateActionTypes;
//      
 ...
 */
function generateActionTypes(commonPrefix, topLevelTypes) {
  var rv = {};
  topLevelTypes.forEach(function (type) {
    var fullType = commonPrefix + "/" + type;
    rv[type] = fullType;
  });
  return rv;
}